...
You can provide a custom SVG element to be used as the pointer shape. This allows  to use a custom graphic or icon as a pointer instead of the default round shape.

<br/>
<div id="custom-pointer-slider"></div>
<br/>
<br/>

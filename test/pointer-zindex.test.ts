...
describe('handlePointerZIndex()', () => {
    ...
    test('returns unmodified pointers array when pointers length is less than or equal to 1', () => {
        ...
        const pointers: IStatePointer[] = [{ pointerRadii: [10, 10], percent: 50, id: '1', index: 0, disabled: false, keyboardDisabled: false, mousewheelDisabled: false, bgColor: '#000' }];
    ...
    test('returns modified pointers array with active pointer moved to the end (multiple pointers)', () => {
        ...
        const pointers: IStatePointer[] = [
            ...
            { pointerRadii: [10, 10], percent: 60, id: '4', index: 3, disabled: false, keyboardDisabled: false, mousewheelDisabled: false, bgColor: '#000' },
        ];
